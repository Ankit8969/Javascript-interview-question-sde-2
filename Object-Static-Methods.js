...
ingredientsList[1]['list'] = ['a','b','c']

console.log(ingredientsList);
console.log(ingredientsShallowCopy)
...
an underscore (e.g., _name) to distinguish it from the public property (e.g., name). This prevents an infinite loop that would occur 
if you tried to directly get or set the same property within its own getter or setter.
...
console.log(descriptor1); //  { value: 42, writable: false, enumerable: true, configurable: false }


// / -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Object.groupBy() --------> Very usefull and handy feature
const inventory = [
