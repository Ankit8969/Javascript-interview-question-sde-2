...
### What is ```srcset``` ?
* ```srcset``` allows the browser to choose the best image version based on:
...
<img
  ...
  srcset="
    ...
    image-474.jpg 2x,
    image-736.jpg 3x,
    image-original.jpg 4x
  "
/>
```

### 🔍 What does 1x, 2x, 3x mean?
* These refer to device pixel ratio (DPR)
- Device	DPR
- Normal screen	1x
- Retina display	2x
- High-end phones	3x / 4x
