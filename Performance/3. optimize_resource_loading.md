...
### When we have to use async or whe we have to use defer ?

### async
Use async when the script is independent of other scripts and the HTML DOM.
...
HTML parsing ────────────────────────→
       ...
       └── JS finishes downloading
          ...
          HTML parsing pauses
             ...
             continue
```
***Important: execution order is not guaranteed.***

Good examples:

- Google Analytics
- Ads
- Independent tracking scripts
- Scripts that don't depend on other scripts


### defer
Use defer when the script depends on the DOM or other scripts.
```
...
HTML parsing ────────────────────────→
       ...
       └──────── HTML parsing finishes
                  ...
                  execute JS
```
Deferred scripts execute after HTML parsing is complete and preserve their order.
